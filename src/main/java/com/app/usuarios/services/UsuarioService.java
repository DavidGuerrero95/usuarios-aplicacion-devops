...
public class UsuarioService implements IUsuarioService {
	...
	public Usuario editUser(Usuario uDb, Usuario usuario) {
		if(usuario.getCedula() != null) {
			if(!uRepository.existsByCedula(usuario.getCedula())) {
				uDb.setVCedula(true);
				uDb.setCedula(usuario.getCedula());
			}else {
				throw new ResponseStatusException(HttpStatus.BAD_REQUEST, "Cedula ya existe");
			}
		}
